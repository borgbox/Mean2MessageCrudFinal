...
class _View_AuthenticationComponent0 extends import1.AppView<import3.AuthenticationComponent> {
  ...
  _RouterOutlet_21_5:import15.RouterOutlet;
  _text_22:any;
  _el_23:any;
  _text_24:any;
  /*private*/ _expr_0:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_21 = this.renderer.createElement(this._el_18,'router-outlet',(null as any));
    this._appEl_21 = new import2.AppElement(21,18,this,this._el_21);
    this._RouterOutlet_21_5 = new import15.RouterOutlet(this.parentInjector.get(import21.RouterOutletMap),this._appEl_21.vcRef,this.parentInjector.get(import22.ComponentFactoryResolver),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import15.RouterOutlet) && (21 === requestNodeIndex))) { return this._RouterOutlet_21_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_AuthenticationComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AuthenticationComponent> {
  if ((renderType_AuthenticationComponent === (null as any))) { (renderType_AuthenticationComponent = viewUtils.createRenderComponentType('C:/CURSO-MEAN-2/assets/app/auth/authentication.component.ts class AuthenticationComponent - inline template',0,import9.ViewEncapsulation.None,styles_AuthenticationComponent,{})); }
