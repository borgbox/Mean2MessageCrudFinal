...
const styles_ErrorComponent:any[] = ['background-color[_ngcontent-%COMP%]:   rgba(0[_ngcontent-%COMP%], 0[_ngcontent-%COMP%], 0[_ngcontent-%COMP%], 0.6)[_ngcontent-%COMP%];\n                position[_ngcontent-%COMP%]:   fixed[_ngcontent-%COMP%];\n                top[_ngcontent-%COMP%]:   0[_ngcontent-%COMP%];\n                left[_ngcontent-%COMP%]:0;\n                width[_ngcontent-%COMP%]:100%;\n                height:100vh'];
...
export function viewFactory_ErrorComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ErrorComponent> {
  if ((renderType_ErrorComponent === (null as any))) { (renderType_ErrorComponent = viewUtils.createRenderComponentType('C:/CURSO-MEAN-2/assets/app/errors/error.component.html',0,import9.ViewEncapsulation.Emulated,styles_ErrorComponent,{})); }
